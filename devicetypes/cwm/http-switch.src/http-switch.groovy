 ...
 */
metadata {
  definition (name: "Http Switch", namespace: "cwm", author: "Neil Cumpstey", vid: "generic-switch") {
    capability "Actuator"
    capability "Switch"
  ...
  preferences {
    input("url", "text", title: "Url", description: "")
    input("auth", "text", title: "Authorization header", description: "")
